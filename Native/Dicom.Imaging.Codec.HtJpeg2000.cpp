...
EXPORT_OpenJPH EncodeStatus InvokeHTJ2KEncode(struct Htj2k_outdata* j2c_outinfo, const unsigned char *source, size_t sourceLength, const struct Frameinfo *finfo, ojph::PROGRESSION_ORDER progression_order)
{
    return HTJpeg2000EncodeStream(j2c_outinfo, source, sourceLength, finfo, progression_order);
}
