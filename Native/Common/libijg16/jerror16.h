...
JMESSAGE(JERR_IMAGE_TOO_BIG, "Maximum supported image dimension is %d pixels")
...
JMESSAGE(JTRC_APP0, "Unknown APP0 marker (not JFIF), length %d")
JMESSAGE(JTRC_APP14, "Unknown APP14 marker (not Adobe), length %d")
JMESSAGE(JTRC_DAC, "Define Arithmetic Table 0x%02x: 0x%02x")
JMESSAGE(JTRC_DHT, "Define Huffman Table 0x%02x")
JMESSAGE(JTRC_DQT, "Define Quantization Table %d  precision %d")
JMESSAGE(JTRC_DRI, "Define Restart Interval %d")
JMESSAGE(JTRC_EMS_CLOSE, "Freed EMS handle %d")
JMESSAGE(JTRC_EMS_OPEN, "Obtained EMS handle %d")
...
JMESSAGE(JTRC_JFIF_EXTENSION,
	 "JFIF extension marker: type 0x%02x, length %d")
JMESSAGE(JTRC_JFIF_THUMBNAIL, "    with %d x %d thumbnail image")
JMESSAGE(JTRC_MISC_MARKER, "Miscellaneous marker 0x%02x, length %d")
...
JMESSAGE(JTRC_SOF, "Start Of Frame 0x%02x: width=%d, height=%d, components=%d")
...
JMESSAGE(JTRC_THUMB_JPEG,
	 "JFIF extension marker: JPEG-compressed thumbnail image, length %d")
JMESSAGE(JTRC_THUMB_PALETTE,
	 "JFIF extension marker: palette thumbnail image, length %d")
JMESSAGE(JTRC_THUMB_RGB,
	 "JFIF extension marker: RGB thumbnail image, length %d")
JMESSAGE(JTRC_UNKNOWN_LOSSLESS_IDS,
	 "Unrecognized component IDs %d %d %d, assuming RGB")
JMESSAGE(JTRC_UNKNOWN_LOSSY_IDS,
	 "Unrecognized component IDs %d %d %d, assuming YCbCr")
JMESSAGE(JTRC_XMS_CLOSE, "Freed XMS handle %d")
JMESSAGE(JTRC_XMS_OPEN, "Obtained XMS handle %d")
