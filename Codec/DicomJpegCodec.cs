        ...
        public override void Decode(DicomPixelData oldPixelData, DicomPixelData newPixelData, DicomCodecParams parameters)
        {
            try
            {
                ...
                try
                {
                    ...
                    {
                        // if the internal scanner chokes on an image, try again using native header reader by libjpeg-turbo
                ...
                catch (DicomCodecException e)
                {
                    ...
                    // assume the correct encoder was used and let libjpeg-turbo handle the rest
                    if (isjPEG)
